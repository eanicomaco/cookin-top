...
import { ingredientesLista1EstaoNaLista2 } from '@/operacoes/listas';
...
onMounted(async () => {
    ...
    receitasEncontradas.value = receitas.filter((receita) => {
        // Lógica:
        // Se todos os ingredientes estiverem na lista, traz a receita (retorna 'true')

        const podeFazer = ingredientesLista1EstaoNaLista2(receita.ingredientes, props.ingredientes);
